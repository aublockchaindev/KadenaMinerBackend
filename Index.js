...
const mintContractService = async (req) => {
 ...
 const cmdObj = {
   keyPairs: KP,
    ...
    networkId: 'testnet04',
    pactCode: Pact.lang.mkExp('free.kor-create-nft.set-values', mintInput.ownerAddress,mintInput.createdDate,mintInput.nftValue, mintInput.createdDate,mintInput.hashRate),
    keyPairs: {
